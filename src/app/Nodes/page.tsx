  ...
  return (
    <>
      ...
      <section className="w-screen flex flex-col gap-12 items-center md:p-20 p-10 max-sm:px-4 pt-20 pb-0 md:pb-0 bg-[#080808] min-h-screen text-white overflow-x-hidden">
        <h1 className="text-8xl max-lg:text-5xl max-sm:text-3xl unbordered-white mt-8">DECENTRALIZATION</h1>
        ...
        <div className="w-full flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
                <p className="para flex gap-2 items-start"><FaCircle className="text-xs" /><b>No Singal Point of Failure:</b> The network remians operational even if one node goes offline.</p>
                <p className="para flex gap-2 items-start"><FaCircle className="text-xs" /><b className="max-sm:mr-4">Enhanced Security:</b> Decentralized data storage signficantly reduces the risk of attack.</p>
                <p className="para flex gap-2 items-start"><FaCircle className="text-xs" /><b className="max-sm:mr-2">Resilience and Scalability:</b> The system evolves and adapts seamlessly to the growing needs of the community.</p>
            </div>
