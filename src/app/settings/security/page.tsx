...
function Security() {
  return (
    ...
    <div className='flex flex-col gap-2 w-2/3 max-sm:w-full'>
      ...
      <div className='w-full flex justify-between items-center pt-24 max-md:flex-col'>
        ...
        <div className='absolute hidden group-hover:flex duration-200 max-md:-left-24 max-sm:-left-7 group-hover:duration-200 flex-col gap-1 p-2 border border-[#004AAD] rounded-2xl text-[8px] w-60 max-sm:w-40 left-full bottom-full translate-x-6'>
