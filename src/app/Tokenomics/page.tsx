...
function Page() {
  return (
    ...
    <div className='bg-[#080808] text-white min-h-screen p-10 md:p-20 pb-0 md:pb-0'>
        ...
        <h1 className='mt-10 md:mt-20 text-[9vw] unbordered-white relative z-10 before:absolute before:w-[85vw] before:rounded-xl boxShadow2 before:h-10 before:top-16 before:translate-y-4 before:bg-[#CD7F32] flex justify-center items-center before:-z-10'>TOKENOMICS</h1>
        </div>
